...
const reviewOnlineRequestsFemales= errorHandling.asyncHandler(async(req, res, next) => {
...
const reviewOnlineRequestsMales= errorHandling.asyncHandler(async(req, res, next) => {
    // Extract query parameter
    var { ofYear, egyptions, expartriates, normalHousing, specialHousing,
         oldStudent,newStudent, newApplications,
        rejectedApplications
